 ...
 * The numbers from 0-9 have 1 digit therefore we don't want to process them; also we don't want to process negative numbers,
    ...
    public static int sumDigits(int number) {
        if (number >= 10) {
            ...
            while (number > 0) {
                ...
                digit = number % 10;
                //adds last digit to the variables sum
                sum = sum + digit;
